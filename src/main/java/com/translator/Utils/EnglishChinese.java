 ...
 * 
 */
@WebServiceClient(name = "EnglishChinese", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/D:/code/Translator/EnglishChinese.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/code/Translator/EnglishChinese.xml");
